...
class TestRail {
    ...
    publish(name, description, results, test_cap_data ,callback = undefined) {
        ...
        let createARun = (isSuiteANumber && numberOfCapabilities == 1 && this.options.updateRun);

        if ((typeof this.options.suiteId !== 'number' || numberOfCapabilities > 1) && createARun !== true) {
